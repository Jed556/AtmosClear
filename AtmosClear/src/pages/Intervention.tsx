                ...
                <main>
                    ...
                    <div className="intervention-container">
                        <div className="intervention-card">
                            <div className="intervention-header">Intervention Level 1</div>
                            <div className="intervention-body">
                                <p className="action"><b>Action:</b> No intervention needed. Air quality is healthy for all.</p>
                                <p className="school"><b>School Suspension:</b> No.</p>
                                <p className="car"><b>Car Usage:</b> No restrictions.</p>
                                <p className="mask"><b>Mask Use:</b> Not required.</p>
                                <div className="age-group"><b>Ages 14 below:</b></div>
                                <p className="impact">None</p>
                                <div className="age-group"><b>Ages 18 to 44:</b></div>
                                <p className="impact">None</p>
                                <div className="age-group"><b>Ages 60 above:</b></div>
                                <p className="impact">None</p>
                            </div>
                        </div>
                        ...
                        <div className="intervention-card">
                            ...
                            <div className="intervention-body">
                                <p className="action"><b>Action:</b> Sensitive groups should limit prolonged outdoor activities.</p>
                                <p className="school"><b>School Suspension:</b> No.</p>
                                <p className="car"><b>Car Usage:</b> No restrictions.</p>
                                <p className="mask"><b>Mask Use:</b> Not required, but optional for sensitive groups.</p>
                                <div className="age-group"><b>Ages 14 below:</b></div>
                        ...
                        <div className="intervention-card">
                            ...
                            <div className="intervention-body">
                                <p className="action"><b>Action:</b> Sensitive groups (children, elderly, and people with pre-existing conditions) should avoid strenuous outdoor activities.</p>
                                <p className="school"><b>School Suspension:</b> No, but consider excusing sensitive students.</p>
                                <p className="car"><b>Car Usage:</b> No restrictions.</p>
                                <p className="mask"><b>Mask Use:</b> Optional for sensitive individuals.</p>
                                <div className="age-group"><b>Ages 14 below:</b></div>
                        ...
                        <div className="intervention-card">
                            ...
                            <div className="intervention-body">
                                <p className="action"><b>Action:</b> General population should reduce outdoor activities. Sensitive groups should avoid outdoor exposure entirely.</p>
                                <p className="school"><b>School Suspension:</b> No, but outdoor activities should be restricted.</p>
                                <p className="car"><b>Car Usage:</b> Minimize; encourage public transport.</p>
                                <p className="mask"><b>Mask Use:</b> Recommended for sensitive groups.</p>
                                <div className="age-group"><b>Ages 14 below:</b></div>
                        ...
                        <div className="intervention-card">
                            ...
                            <div className="intervention-body">
                                <p className="action"><b>Action:</b> All individuals should avoid outdoor activities. Stay indoors as much as possible.</p>
                                <p className="school"><b>School Suspension:</b> Yes, especially for outdoor activities.</p>
                                <p className="car"><b>Car Usage:</b> Minimize to essential use only.</p>
                                <p className="mask"><b>Mask Use:</b> Mandatory for everyone when outdoors or in areas with poor indoor ventilation.</p>
                                <div className="age-group"><b>Ages 14 below:</b></div>
                        ...
                        <div className="intervention-card">
                            ...
                            <div className="intervention-body">
                                <p className="action"><b>Action:</b> Emergency conditions. Stay indoors, avoid all outdoor exposure.</p>
                                <p className="school"><b>School Suspension:</b> Yes. Schools should close.</p>
                                <p className="car"><b>Car Usage:</b> Only for emergencies.</p>
                                <p className="mask"><b>Mask Use:</b> Mandatory for all, including indoors if air quality is poor or unfiltered.</p>
                                <div className="age-group"><b>Ages 14 below:</b></div>
